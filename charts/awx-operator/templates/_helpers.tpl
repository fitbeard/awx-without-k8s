...
Common labels
*/}}
{{- define "awx-operator.labels" -}}
helm.sh/chart: {{ include "awx-operator.chart" . }}
{{ include "awx-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "awx-operator.selectorLabels" -}}
...
{{- $default := (include "awx-operator.fullname" .) }}
